...
Session.create!(
  ...
  starts_at: Time.zone.local(2023, 9, second_day, 10, 0),
  ends_at: Time.zone.local(2023, 9, second_day, 11, 0),
  location: track_1,
...
Session.create!(
  ...
  starts_at: Time.zone.local(2023, 9, second_day, 11, 15),
  ends_at: Time.zone.local(2023, 9, second_day, 11, 45),
  location: track_1,
...
Session.create!(
  ...
  starts_at: Time.zone.local(2023, 9, second_day, 13, 0),
  ends_at: Time.zone.local(2023, 9, second_day, 13, 30),
  location: track_1,
...
Session.create!(
  ...
  starts_at: Time.zone.local(2023, 9, second_day, 13, 45),
  ends_at: Time.zone.local(2023, 9, second_day, 14, 15),
  location: track_1,
...
Session.create!(
  ...
  starts_at: Time.zone.local(2023, 9, second_day, 14, 45),
  ends_at: Time.zone.local(2023, 9, second_day, 15, 15),
  location: track_1,
...
Session.create!(
  ...
  starts_at: Time.zone.local(2023, 9, second_day, 15, 45),
  ends_at: Time.zone.local(2023, 9, second_day, 16, 15),
  location: track_1,
...
Session.create!(
  ...
  description: "More information coming soon.",
  starts_at: Time.zone.local(2023, 9, second_day, 16, 30),
  ends_at: Time.zone.local(2023, 9, second_day, 17, 30),
  location: track_1,
